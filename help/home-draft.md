...
# Visão geral da interface central do CX Enterprise
...
* **[!UICONTROL Status]:** Navigate to `https://status.adobe.com/pt-br/experience_cloud` and check product operational status and [!UICONTROL Manage Subscriptions].
...
[!BADGE Beta]{type=Informative url="https://experienceleague.adobe.com/pt-br/docs/core-services/interface/features/account-preferences#notifications" tooltip="Learn about Slack"}
