...
user-guide-title: Guia do usuário dos principais serviços
...
+ Sobre os principais serviços {#about-core-services}
   + [Visão geral dos principais serviços](core-services-landing.md)
...
+ Activation {#activation}
   + [Visão geral de ativação](activation/activation.md)
   + [Guia de inicialização do usuário](https://marketing.adobe.com/resources/help/en_US/experience-cloud/launch/)
   + [Guia do usuário do DTM](https://marketing.adobe.com/resources/help/en_US/dtm/)
   + [Triggers](activation/triggers.md)
+ Assets {#assets}
   + [Visão geral dos ativos](experience-cloud-assets/experience-cloud-assets.md)
   + [Compartilhar pastas e ativos da Experience Cloud com a Creative Cloud](experience-cloud-assets/creative-cloud.md)
   ...
   + [Requisitos do arquivo de ativos para compartilhamento](experience-cloud-assets/assets-file-reqs.md)
...
+ Mais recursos {#more-resources}
   ...
   + [Atualizações de documentação - Experience Cloud](doc-updates.md)
