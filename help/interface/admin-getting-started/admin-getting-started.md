...
Como alternativa, no menu da Experience Cloud ( ![](assets/menu-icon.png)), clique **[!UICONTROL em Administração]** &gt; **[!UICONTROL Iniciar o Admin Console]**.
...
A migração das contas está acontecendo em fases. A Adobe notificará e auxiliará quando for seu momento de migrar contas de usuário existentes de Ferramentas **[!UICONTROL administrativas]** &gt; **[!UICONTROL Gerenciamento de usuários]** para o Admin Console.
...
[Migração de IDs de usuário do Analytics](https://marketing.adobe.com/resources/help/en_US/experience-cloud/admin-console/analytics-migration/)

## Target - perfis de produto x espaços de trabalho {#section_3860AF177C9E4C7E9C390D36A414F353}
...
Consulte:
* [Permissões de usuário empresarial](https://marketing.adobe.com/resources/help/en_US/target/target/property_channel.html)
...
## Campanha - perfis de produto, locatários e grupos de segurança {#section_09CDF75366444CF5810CF321B7C712F3}
...
Consulte [Gerenciamento de grupos e usuários](https://helpx.adobe.com/campaign/standard/administration/using/managing-groups-and-users.html) para obter informações sobre grupos de segurança e atribuir usuários a grupos de segurança.

## Experience Platform Launch{#section_F2DA6778DD2D48AA8F794041971EE6B1}

O Launch da Adobe é exibido na página Produtos do Admin Console. É possível incluir outras soluções e principais serviços em um perfil de produto do Launch.

Consulte [Gerenciamento](https://marketing.adobe.com/resources/help/en_US/experience-cloud/launch/user-management.html) de usuários para obter informações sobre permissões de usuário no Admin Console e configurar opções específicas para o Launch, incluindo a atribuição de direitos a perfis.
...
Consulte [Usuários e permissões](https://marketing.adobe.com/resources/help/en_US/dtm/users.html) para obter informações sobre como convidar usuários para o Gerenciamento dinâmico de tags, atribuir funções de usuário e adicionar usuários a grupos.
...
1. Clique **[!UICONTROL em Novo perfil]**.
1. Configure os detalhes do perfil e clique **[!UICONTROL em Avançar]**.
...
1. No perfil de produto, clique **[!UICONTROL em Permissões]** (disponível apenas para administradores).
...
1. No Admin Console, clique **[!UICONTROL em Usuários]** e, em seguida, clique no nome do usuário.
1. Clique em **[!UICONTROL Editar direitos de administrador]**.
1. Configure os direitos de administrador do usuário.
1. Clique **[!UICONTROL em Avançar]** para rever as configurações e clique **[!UICONTROL em Salvar]**.
