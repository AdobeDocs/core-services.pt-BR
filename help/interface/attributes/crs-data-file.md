---
description: Saiba mais sobre os requisitos do arquivo de dados e várias fontes de dados para fazer upload dos atributos do cliente na Experience Cloud.
