...
1. Preencha o ![formulário de solicitação](assets/FPC_Request_Form.xlsx) e abra um ticket com o Atendimento ao cliente solicitando a configuração de cookies primários no programa Adobe Managed. Cada campo é descrito no documento com exemplos. 
...
* Solicite um certificado SSL, conforme descrito em Etapas de implementação para o Adobe Managed Certificate Program.
* Crie registros CNAME.
* Ping do nome do host.
