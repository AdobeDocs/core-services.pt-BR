---
description: Saiba mais sobre os componentes de interface central para o CX Enterprise (antigo Experience Cloud). Obtenha ajuda sobre a administração de usuários e produtos, habilite aplicativos para serviços de interface compartilhada. Obtenha ajuda sobre a Biblioteca de público-alvo, Atributos do cliente, Assets e muito mais.
title: Guia de administração e interface da CX Enterprise
...
# Interface e administração do CX Enterprise

O [CX Enterprise](https://experience.adobe.com) (antigo _Experience Cloud_) é a família integrada de aplicativos de marketing digital, produtos e serviços da Adobe. Por meio da interface intuitiva, você pode acessar rapidamente seus aplicativos em nuvem, recursos do produto e serviços.

<!-- ![CX Enterprise](assets/landing.png) -->

No cabeçalho do CX Enterprise, é possível:

* Acessar todos os aplicativos e serviços da CX Enterprise
...
1. Verifique se você está na organização correta.
   ...
   **Observação:** o administrador de sua organização pode restringir o acesso aos produtos da Adobe por endereços IP. Em caso positivo, você poderá receber um erro depois de fazer logon no CX Enterprise ou alternar para uma organização com isso ativado. Mais informações disponíveis em [Limitar o acesso ao produto por endereços IP](https://helpx.adobe.com/br/enterprise/using/ip-based-access.html).
...
* **[!UICONTROL Feedback]:** Compartilhe um comentário sobre a sua experiência com o CX Enterprise. Seu feedback é usado para melhorar os produtos e serviços do Adobe.
...
* Gerenciar [Preferências](features/account-preferences.md) do CX Enterprise
