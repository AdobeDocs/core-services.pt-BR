...
Os Adobe Experience Platform Agents são viabilizados pelo [Experience Platform Agent Orchestrator](https://experienceleague.adobe.com/en/docs/experience-cloud-ai/experience-cloud-ai/home) para habilitar recursos de IA agêntica em aplicativos Experience Cloud.
...
| [Agente de Jornada](https://experienceleague.adobe.com/en/docs/experience-cloud-ai/experience-cloud-ai/agents/ajo-agent) | Permita que suas equipes criem, analisem e otimizem rapidamente jornadas multitoque de clientes em escala. | <ul><li>Adobe Journey Optimizer (edições B2B e B2C)</li></ul> |
| [Agente de Suporte ao Produto](https://experienceleague.adobe.com/en/docs/experience-cloud-ai/experience-cloud-ai/agents/product-support) | Solucione problemas de suporte sem sair dos fluxos de trabalho, crie tíquetes de suporte ao cliente e acompanhe o progresso do caso usando o Assistente do AI. | <ul><li>Real-Time CDP (edições B2B, B2C e B2P)</li><li>Adobe Journey Optimizer (edições B2B e B2C)</li><li>Customer Journey Analytics (edições B2B e B2C)</li><li>Adobe Experience Manager</li></ul> |
