...
Depois de implantar o [!UICONTROL AI Assistant], você pode usar o [!UICONTROL AI Monitoring] para obter visibilidade sobre como ele é usado e executado. Ele permite compreender quem usa o [!UICONTROL AI Assistant], quais tarefas ele suporta, onde tem sucesso ou dificuldades e como isso se vincula à adoção, custo e impacto nos negócios.
...
## Repetição da conversa e feedback
