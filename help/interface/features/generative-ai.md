...
| **Adobe Experience Manager 6.5 LTS** | | O Assistente de IA está disponível para: <ul><li>Página de visão geral do Experience Hub<li>Edge Delivery Services</li><li>Sites</li><li>Ativos</li><li>Formulários</li><li>Mídia dinâmica</li><li>Cloud Manager</li></ul> [Saiba mais](https://experienceleague.adobe.com/pt-br/docs/experience-manager-65-lts/content/ai-assistant/ai-assistant-in-aem) |
...
| **Adobe Journey Optimizer B2B edition** | Não aplicável | Disponível para ajudar no conhecimento do produto. [Saiba mais](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview) | Não |
...
| **[!DNL Workfront]** | GenAI é usado com [informações e sugestões no aplicativo](https://experienceleague.adobe.com/pt-br/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en). Saiba mais | Não aplicável | Sim |
