...
| [Adobe Experience Manager Sites](#aem) | Usado em [Gerar Variações](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en) para criar variações de conteúdo com base na entrada. | Não aplicável | Sim |
...
| [[!DNL Workfront]](#workfront) | Usado com informações e sugestões do [no aplicativo](https://experienceleague.adobe.com/pt-br/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en). | Não aplicável | Sim |
