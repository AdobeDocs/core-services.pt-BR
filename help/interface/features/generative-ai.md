...
description: Encontre ajuda sobre IA gerativa (GenAI) e Assistente de IA em aplicativos Experience Cloud.
...
* **Gerar uma resposta:** A IA fornece uma resposta ou reação a um prompt, normalmente com base em seus dados disponíveis e repositórios de conhecimento.
  ...
  A GenAI contrasta com a [IA agêntica](agentic-ai.md) (estrutura agêntica da Adobe), que se refere à IA que opera de forma autônoma.
