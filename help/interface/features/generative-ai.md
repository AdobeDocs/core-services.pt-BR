...
| [Adobe Experience Manager Sites](#aem) | Sim. <br> Disponível em [Gerar Variações](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en) para criar variações de conteúdo com base na entrada. | Não aplicável | Sim |
...
| | | O AJO Prime e o Ultimate oferecem a [Geração de conteúdo](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer/using/content-management/ai-assistant/gs-generative?lang=en) para oferecer sugestões proativas de variação de conteúdo para texto e imagens. | Sim |
...
| [[!DNL Workfront]](#workfront) | Sim. <br> Informações e sugestões no aplicativo. [Saiba mais](https://experienceleague.adobe.com/pt-br/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en) | Não aplicável | Sim |
...
<!-- [Learn more](https://experienceleague.adobe.com/pt-br/docs/genstudio-for-performance-marketing/user-guide/home) -->
