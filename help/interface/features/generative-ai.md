...
[!BADGE Privacidade, segurança e governança]{type=Informative url="https://experienceleague.adobe.com/pt-br/docs/experience-platform/ai-assistant/privacy" tooltip="GenAI na Adobe"}
...
| **Adobe Experience Manager as a Cloud Service (AEM CS)** | A IA está disponível em:<ul><li>[Gerar Variações](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor) em **AEM Sites**</li><li>[GenAI](https://experienceleague.adobe.com/pt-br/docs/experience-manager-sites-optimizer/content/opportunity-types/overview) em **Sites Optimizer**</li><li>[Content Hub](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview?lang=en) e [Tags inteligentes](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/assets/manage/smart-tags?lang=en#ai-smart-tags) no **AEM Assets**</li></ul> [Saiba mais](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/generative-ai/generative-ai-in-aem) <br> | O Assistente de IA está disponível para: <ul><li>Página de visão geral do Experience Hub<li>Edge Delivery Services</li><li>Sites</li><li>Ativos</li><li>Formulários</li><li>Mídia dinâmica</li><li>Cloud Manager</li></ul> [Saiba mais](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/ai-assistant/ai-assistant-in-aem) | Sim |
| **Adobe Experience Manager 6.5** | | O Assistente de IA está disponível para: <ul><li>Página de visão geral do Experience Hub<li>Edge Delivery Services</li><li>Sites</li><li>Ativos</li><li>Formulários</li><li>Mídia dinâmica</li><li>Cloud Manager</li></ul> [Saiba mais](https://experienceleague.adobe.com/pt-br/docs/experience-manager-65/content/ai-assistant/ai-assistant-in-aem) | Sim |
| **Adobe Experience Manager 6.5 LTS** | | O Assistente de IA está disponível para: <ul><li>Página de visão geral do Experience Hub<li>Edge Delivery Services</li><li>Sites</li><li>Ativos</li><li>Formulários</li><li>Mídia dinâmica</li><li>Cloud Manager</li></ul> [Saiba mais](https://experienceleague.adobe.com/pt-br/docs/experience-manager-65-lts/content/ai-assistant/ai-assistant-in-aem) | Sim |
| **Adobe Experience Platform** | | Disponível para conhecimento do produto e insights operacionais. [Saiba mais](https://experienceleague.adobe.com/pt-br/docs/experience-platform/ai-assistant/landing) | Não |
...
| **Adobe Journey Optimizer B2B edition** |  | Disponível para ajudar no conhecimento do produto. [Saiba mais](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview) | Não |
| **[!DNL Campaign]Managed Cloud Services** |  | Disponível para o Acelerador de conteúdo para gerar automaticamente conteúdo personalizado, envolvente e eficaz com base nos objetivos de marketing em canais como email, SMS e push. [Saiba mais](https://experienceleague.adobe.com/pt-br/docs/campaign-web/v8/content/ai-assistant/generative-gs) | Sim |
...
| **[!DNL Workfront]** |  | Disponível para informações e sugestões no aplicativo. [Saiba mais](https://experienceleague.adobe.com/pt-br/docs/workfront/using/basics/ai-assistant/ai-assistant-overview) | Sim |
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/generative-ai/generative-ai-in-aem" tooltip="Ir para GenAI no AEM CS"}
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/ai-assistant/ai-assistant-in-aem" tooltip="Ir para o Assistente de IA no AEM"}
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/pt-br/docs/experience-platform/ai-assistant/landing" tooltip="Assistente de IA no Adobe Experience Platform"}
