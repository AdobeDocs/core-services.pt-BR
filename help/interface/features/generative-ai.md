...
| **Adobe Journey Optimizer** | Não aplicável | Disponível para conhecimento do produto e insights operacionais. [Saiba mais](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer/using/get-started/ai-assistant) | Não |
...
| **Adobe Journey Optimizer B2B edition** | Não aplicável | Disponível para ajudar no conhecimento do produto. [Saiba mais](https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview) | Não |
| **[!DNL Campaign]Managed Cloud Services** | Não aplicável | Disponível para o Acelerador de conteúdo para gerar automaticamente conteúdo personalizado, envolvente e eficaz com base nos objetivos de marketing em canais como email, SMS e push. [Saiba mais](https://experienceleague.adobe.com/en/docs/campaign-web/v8/content/ai-assistant/generative-gs) | Sim |
...
| **Real-Time CDP** | Não aplicável | Disponível para conhecimento sobre o produto na Experience League. Também oferece insights operacionais. [Saiba mais](https://experienceleague.adobe.com/pt-br/docs/experience-platform/ai-assistant/home) | Não |
...
| **[!DNL Workfront]** | GenAI é usado com [informações e sugestões no aplicativo](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en). Saiba mais | Não aplicável | Sim |
