...
|------------------|-------------------------|------------------|---------------------------|
| [Adobe GenStudio for Performance Marketing](#gspm) | O GenStudio para Marketing de desempenho é um aplicativo genAI. Ele ajuda as equipes de marketing e criação a criarem conteúdo personalizado na marca. | Não aplicável | Sim |
| [Adobe Experience Manager Sites](#aem) | GenAI é usado em [Gerar Variações](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en) para criar variações de conteúdo com base na entrada. | Não aplicável | Sim |
| [Sites Optimizer](#aem) | A GenAI ajuda você a analisar e melhorar o desempenho e a eficácia das experiências da Web. | Não aplicável | Não |
...
| [[!DNL Campaign] Serviços gerenciados na nuvem](#campaign-cs) | Não aplicável | Disponível para Acelerador de conteúdo para gerar automaticamente conteúdo personalizado, envolvente e eficaz com base nos objetivos de marketing em canais como email, SMS e push | Sim |
...
| [[!DNL Real-Time CDP]](#rtcdp) | Não aplicável | Disponível para conhecimento sobre o produto na Experience League. Ele também oferece insights operacionais (em beta). | Não |
...
| [[!DNL Workfront]](#workfront) | GenAI é usado com [informações e sugestões no aplicativo](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en). | Não aplicável | Sim |
