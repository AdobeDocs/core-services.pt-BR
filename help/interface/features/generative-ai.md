...
| **Adobe Journey Optimizer** | Não aplicável | Disponível para conhecimento do produto e insights operacionais. | Não | [!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/pt-br/docs/journey-optimizer/using/get-started/ai-assistant" tooltip="Saiba mais sobre o Assistente de IA no AJO"} |
...
| **Adobe Journey Optimizer B2B edition** | Não aplicável | Disponível para ajudar no conhecimento do produto. | Não | [!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview" tooltip="Saiba mais sobre o Assistente de IA no AJO"} |
