...
* [Agente de Suporte ao Produto](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/new-features/customer-support) para criar tíquetes de suporte ao cliente, preenchidos com detalhes de contexto e sessão de suas interações com o Assistente de IA.
