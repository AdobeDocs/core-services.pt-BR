...
|------------------|-------------------------|------------------|---------------------------|
| [Adobe GenStudio for Performance Marketing](#gspm) | Um aplicativo genAI que ajuda as equipes de marketing e criação a criar conteúdo personalizado na marca. | Não aplicável | Sim |
| [Adobe Experience Manager Sites](#aem) | Usado em [Gerar Variações](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en) para criar variações de conteúdo com base na entrada. | Não aplicável | Sim |
| [Sites Optimizer](#aem) | Ajuda a analisar e melhorar o desempenho e a eficácia das experiências da Web. | Não aplicável | Não |
| [Adobe Experience Manager Assets](#aem) | Usado em [Content Hub](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview?lang=en) e [Marcas Inteligentes](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/manage/smart-tags?lang=en#ai-smart-tags) geradas por IA. | Não aplicável | Sim |
| [Adobe Journey Optimizer](#journey-optimizer) | Não aplicável | Disponível para conhecimento do produto e insights operacionais. | Não |
...
| [[!DNL Adobe Journey Optimizer] B2B edition](#ajo-b2b) | Não aplicável | Disponível para ajudar no conhecimento do produto. | Não |
| [[!DNL Campaign] Serviços gerenciados na nuvem](#campaign-cs) | Não aplicável | Usa o Assistente de IA para Acelerador de conteúdo para gerar automaticamente conteúdo personalizado, envolvente e eficaz com base nos objetivos de marketing em canais como email, SMS e push | Sim |
| [[!DNL Customer Journey Analytics]](#cja) | Usado com:<ul><li> [Legendas inteligentes](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/intelligent-captions?lang=en): para obter insights sobre as visualizações do Workspace usadas com mais frequência.</li><li>[Content Analytics](https://experienceleague.adobe.com/en/docs/analytics-platform/using/content-analytics/report/report?lang=en#template): para atribuir metadados de ativos automaticamente.</li></ul> | O Assistente de IA pode ajudar com:<ul><li>[Conhecimento do produto](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/ai-assistant?lang=en) (Experience League)</li><li>[Agente de Suporte ao Produto](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/new-features/customer-support?lang=en) </li><li>[Data Insights Agent](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/data-analysis-ai)</li></ul> | Não |
| [[!DNL Real-Time CDP]](#rtcdp) | Não aplicável | Conhecimento do produto da Experience League. Ele também oferece insights operacionais (em beta). | Não |
| [[!DNL Marketo]](#marketo) | Disponível em [Dynamic Chat](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/dynamic-chat/generative-ai/overview?lang=en) e [Webinars interativos](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/events/interactive-webinars/gen-ai?lang=en). | Não aplicável | Não |
| [[!DNL Workfront]](#workfront) | Usado com informações e sugestões do [no aplicativo](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en). | Não aplicável | Sim |
