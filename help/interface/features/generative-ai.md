...
>[!IMPORTANT]
>
>Antes de usar os recursos de IA gerativa da Experience Cloud, você deve entender e seguir as [Diretrizes de usuário da IA gerativa da Adobe Experience Cloud](https://www.adobe.com/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html).
...
O [!UICONTROL Assistente de IA] é uma ferramenta de genAI conversacional com suporte em vários aplicativos do Experience Cloud. Use-o para obter rapidamente _conhecimento sobre o produto_ e _insights operacionais_, dependendo do aplicativo que você estiver usando.

* **Conhecimento do produto:** o conhecimento do produto refere-se a conceitos e tópicos com base na documentação do Experience League. Por exemplo, use [prompts baseados em objetivos](https://experienceleague.adobe.com/pt-br/docs/experience-platform/ai-assistant/home) para aprender rapidamente sobre o Experience Platform. Todas as respostas do Experience League são verificáveis e citadas com links.

* **Insights operacionais:** Por exemplo, [insights operacionais](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/questions#objects-questions) no Experience Platform se referem a respostas geradas sobre seus objetos de metadados (atributos, públicos, fluxos de dados, conjuntos de dados e assim por diante). Com o [!UICONTROL Assistente de IA], você pode concluir em segundos o que, de outra forma, poderia levar horas ou dias.
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/landing" tooltip="Ir para o Assistente de IA"}

[!BADGE Privacidade, segurança e governança]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/privacy" tooltip="GenAI na Adobe"}

## Quais recursos da genAI são compatíveis? {#ai-roundup}

Este é um resumo dos aplicativos [!DNL Experience Cloud] que usam recursos de IA gerativa e o Assistente de IA. A compatibilidade com o [Adobe Firefly](https://business.adobe.com/products/firefly-business/firefly-ai-approach.html) é indicada para recursos de IA gerativos.

**Observação:** [!DNL Experience Platform Agents] estão descritos em [IA de agente no Experience Cloud](agentic-ai.md).
...
| **Nome do produto** | **Recursos de IA** | **Assistente de IA** | **Compatibilidade com o Firefly** |
|------------------|-------------------------|------------------|-------------------|
| **Adobe GenStudio for Performance Marketing** | O GenStudio for Performance Marketing é um aplicativo genAI. Ele ajuda as equipes de marketing e criação a criarem conteúdo personalizado na marca. [Saiba mais](https://experienceleague.adobe.com/pt-br/docs/genstudio-for-performance-marketing/user-guide/home) | Não aplicável | Sim |
| **Adobe Experience Manager as a Cloud Service (AEM CS)** | A IA está disponível em:<ul><li>[Gerar Variações](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor) em **AEM Sites**</li><li>[GenAI](https://experienceleague.adobe.com/en/docs/experience-manager-sites-optimizer/content/opportunity-types/overview) em **Sites Optimizer**</li><li>[Content Hub](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview?lang=en) e [Tags inteligentes](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/manage/smart-tags?lang=en#ai-smart-tags) no **AEM Assets**</li></ul> [Saiba mais](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generative-ai-in-aem) <br> | O Assistente de IA está disponível para: <ul><li>Página de visão geral do Experience Hub<li>Edge Delivery Services</li><li>Sites</li><li>Ativos</li><li>Formulários</li><li>Mídia dinâmica</li><li>Cloud Manager</li></ul> [Saiba mais](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-assistant/ai-assistant-in-aem) | Sim |
| **Adobe Experience Manager 6.5** | | O Assistente de IA está disponível para: <ul><li>Página de visão geral do Experience Hub<li>Edge Delivery Services</li><li>Sites</li><li>Ativos</li><li>Formulários</li><li>Mídia dinâmica</li><li>Cloud Manager</li></ul> [Saiba mais](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/ai-assistant/ai-assistant-in-aem) | Sim |
| **Adobe Experience Manager 6.5 LTS** | | O Assistente de IA está disponível para: <ul><li>Página de visão geral do Experience Hub<li>Edge Delivery Services</li><li>Sites</li><li>Ativos</li><li>Formulários</li><li>Mídia dinâmica</li><li>Cloud Manager</li></ul> [Saiba mais](https://experienceleague.adobe.com/en/docs/experience-manager-65-lts/content/ai-assistant/ai-assistant-in-aem) | Sim |
| **Adobe Experience Platform** | | Disponível para conhecimento do produto e insights operacionais. [Saiba mais](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/landing) | Não |
| **Adobe Journey Optimizer** | | Disponível para conhecimento do produto e insights operacionais. [Saiba mais](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer/using/get-started/ai-assistant) | Não |
...
| **Adobe Journey Optimizer B2B edition** |  | Disponível para ajudar no conhecimento do produto. [Saiba mais](https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview) | Não |
| **[!DNL Campaign]Managed Cloud Services** |  | Disponível para o Acelerador de conteúdo para gerar automaticamente conteúdo personalizado, envolvente e eficaz com base nos objetivos de marketing em canais como email, SMS e push. [Saiba mais](https://experienceleague.adobe.com/en/docs/campaign-web/v8/content/ai-assistant/generative-gs) | Sim |
| **[!DNL Customer Journey Analytics]** | A IA é usada com:<ul><li> [Legendas inteligentes](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/intelligent-captions?lang=en): para obter insights sobre as visualizações do Workspace usadas com mais frequência.</li><li>[Content Analytics](https://experienceleague.adobe.com/en/docs/analytics-platform/using/content-analytics/report/report?lang=en#template): para atribuir metadados de ativos automaticamente.</li></ul> | Disponível para:<ul><li>[Conhecimento do produto](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/ai-assistant?lang=en) (Experience League)</li><li>[Agente de Suporte ao Produto](agentic-ai.md) </li><li>[Data Insights Agent](agentic-ai.md)</li></ul> | Não |
| **Real-Time CDP** |  | Disponível para conhecimento sobre o produto na Experience League. Também oferece insights operacionais. [Saiba mais](https://experienceleague.adobe.com/pt-br/docs/experience-platform/ai-assistant/home) | Não |
| **[!DNL Marketo]** | A IA está disponível no Email Designer (com Firefly), [Dynamic Chat](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/dynamic-chat/generative-ai/overview?lang=en) e [Webinars interativos](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/events/interactive-webinars/gen-ai?lang=en). | Disponível no Marketo Engage [Designer de email](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/email-marketing/email-designer/ai-assistant) | Sim |
| **[!DNL Workfront]** |  | Disponível para informações e sugestões no aplicativo. [Saiba mais](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview) | Sim |

## Como posso usar a IA gerativa no Experience Cloud? {#products}
...
#### IA gerativa no AEM as a Cloud Service

A Adobe Generative AI for Adobe Experience Manager (AEM) as a Cloud Service permite que as marcas criem experiências de alto desempenho com a geração de cópia e imagem, tudo dentro da interface de edição.

[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generative-ai-in-aem" tooltip="Ir para GenAI no AEM CS"}

#### Assistente de IA no AEM CS

O Assistente de IA do [!DNL Experience Manager as a Cloud Service] ajuda você a obter respostas instantâneas para suas perguntas sobre produtos da AEM (disponíveis para todos os usuários) e a automatizar a criação de tíquetes de suporte (disponíveis para Administradores de Suporte).

O Assistente de IA é compatível com o AEM as a Cloud Service nos seguintes locais:
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-assistant/ai-assistant-in-aem" tooltip="Ir para o Assistente de IA no AEM"}
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor" tooltip="Ir para Gerar variações no Experience League"}
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-manager-sites-optimizer/content/opportunity-types/overview" tooltip="Ir para o Sites Optimizer no Experience League"}
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview" tooltip="Ir para o Content Hub no Experience League"}
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/manage/smart-tags#ai-smart-tags" tooltip="Saiba mais sobre Tags inteligentes"}
...
O Assistente de IA no Adobe Experience Platform é uma ferramenta de bate-papo que ajuda você a trabalhar com mais rapidez nos aplicativos Adobe. Você pode usá-lo para:

* Saiba como o produto funciona
* Obter ajuda para resolver problemas
* Procure informações e insights sobre seus dados e configuração

O Assistente de IA está disponível no Experience Platform, Real-Time Customer Data Platform, Adobe Journey Optimizer e Customer Journey Analytics. (Descrito abaixo)

[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/landing" tooltip="Assistente de IA no Adobe Experience Platform"}
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview" tooltip="Saiba mais sobre o Assistente de IA no AJO"}
...
* [Assistente de IA](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/ai-assistant) para obter conhecimento sobre o produto.
* [Legendas inteligentes](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/intelligent-captions) para fornecer insights importantes para as visualizações do Workspace usadas com mais frequência em linguagem natural.
* [Content Analytics](https://experienceleague.adobe.com/en/docs/analytics-platform/using/content-analytics/report/report#template) para atribuir todos os metadados de ativos automaticamente.
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/ai-assistant" tooltip="Saiba mais sobre o Assistente de IA no CJA"}
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/intelligent-captions" tooltip="Saiba mais sobre Legendas inteligentes"}
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/content-analytics/report/report#template" tooltip="Saiba mais sobre o Content Analytics"}
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/en/docs/campaign-web/v8/content/ai-assistant/generative-gs" tooltip="Saiba mais sobre o Assistente de IA no AJO"}
...
No Marketo, a IA gerativa está disponível em Webinars interativos e no Dynamic Chat. O Assistente de IA está disponível em Email Designer.
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/events/interactive-webinars/gen-ai" tooltip="Saiba mais sobre webinários interativos"}
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/dynamic-chat/generative-ai/overview" tooltip="Saiba mais sobre o Dynamic Chat"}
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/email-marketing/email-designer/ai-assistant" tooltip="Saiba mais sobre o Dynamic Chat"}

**GenStudio for Performance Marketing**

O Marketo integra-se ao GenStudio for Performance Marketing
...
[!BADGE Saiba mais]{type=Informative url="https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview" tooltip="Saiba mais sobre o Assistente de IA no Workfront"}
...
* [Recursos de IA Responsáveis na Central de Confiabilidade](https://www.adobe.com/trust/responsible-ai.html?lang=pt-BR)<!-- * [Customer AI Propensity Scoring Model Card](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/model-cards/ai-model-cards/customer-ai) -->
