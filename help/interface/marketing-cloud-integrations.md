...
O serviço de ID fornece uma ID persistente e universal que identifica os visitantes em todos os aplicativos no Experience Cloud. Ele permite substituir o código de geração de ID para serviços como o Analytics, o Audience Manager, o Adobe Target, o video heartbeat e outros aplicativos e produtos da Experience Cloud.

Consulte [Experience Cloud ID Service](https://experienceleague.adobe.com/docs/id-service/using/home.html?lang=en)

**Aplicações ou serviços aplicáveis**
...
Compartilhe pastas e ativos entre a Experience Cloud e a Creative Cloud. Colabore, anote ativos compartilhados e use-os em aplicativos Experience Cloud como [!DNL Social] e [!DNL Target].
...
Trabalhe com dados de aplicativos Experience Cloud ou outros sistemas externos no Audience Manager.
...
* [Integração de dados do Adobe Target](https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-other-applications/aam-target-integration.html?lang=en)
...
Use os aplicativos Experience Cloud Ativation para configurar e depurar os aplicativos Experience Cloud.
...
Integre o Adobe Target ao Adobe Analytics e outros aplicativos do Experience Cloud para permitir o uso dos mesmos dados, públicos, atributos e métricas em ambos os aplicativos.
...
Integre o AEM a outros aplicativos e serviços de terceiros.
