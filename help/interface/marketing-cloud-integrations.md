...
O serviço de ID fornece uma ID contínua e universal que identifica os visitantes por todas as soluções na Experience Cloud. Ele permite substituir o código de geração de ID para serviços como o Analytics, o Audience Manager, o Adobe Target, o video heartbeat e outros aplicativos e produtos da Experience Cloud.
...
* [Integração de dados do Adobe Target](https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-other-solutions/aam-target-integration.html?lang=pt-BR)

## Activation {#section_A23510A2D57842F6BAD043650C06DE42}

Ajuda: [Introdução](https://experienceleague.adobe.com/docs/launch/using/get-started/quick-start.html?lang=pt-BR#get-started)

Use as soluções de Experience Cloud Activation para configurar e depurar as soluções da Experience Cloud.

1. Use [Experience Platform Launch](https://experienceleague.adobe.com/docs/launch/using/home.html?lang=pt-BR) ou [Dynamic Tag Management](https://experienceleague.adobe.com/docs/dtm/using/dtm-home.html?lang=pt-BR) para inserir o código que ativa os aplicativos Experience Cloud nas suas páginas.
...
* [Audience Manager](https://experienceleague.adobe.com/docs/dtm/using/tools/audiencemgmt.html?lang=pt-BR)
* [Media Optimizer](https://experienceleague.adobe.com/docs/dtm/using/tools/media-optimizer.html?lang=pt-BR)
* [Adobe Target](https://experienceleague.adobe.com/docs/dtm/using/tools/target.html?lang=pt-BR)
* [Serviço MAC ID](https://experienceleague.adobe.com/docs/dtm/using/tools/macid.html?lang=pt-BR)
* [Rastreamento Nielsen](https://experienceleague.adobe.com/docs/dtm/using/tools/nielsen.html?lang=pt-BR)
...
* Dynamic Tag Management: [Práticas recomendadas de implementação do Adobe Target usando o DTM](https://experienceleague.adobe.com/docs/dtm/implementing/overview.html?lang=pt-BR)
