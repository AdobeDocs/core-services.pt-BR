...
* Define uma organização de Experience Cloud como a organização principal do conjunto de relatórios.
...
Você deve ser um administrador do Analytics de uma empresa de logon que tenha acesso ao conjunto de relatórios que deseja mapear. Além disso, essa conta deve estar [vinculada a uma organização Experience Cloud](organizations.md#topic_C31CB834F109465A82ED57FF0563B3F1) para mapear conjuntos de relatórios para essa organização.
...
Esmaecer uma organização indica que você não tem privilégios suficientes para mapear para o conjunto de relatórios esmaecido. Considere o exemplo a seguir:
...
* Vincularam sua conta de administrador na empresa de logon [!UICONTROL chapek] do Analytics à conta de organização [!UICONTROL Chapek] do Corp Experience Cloud.
* Vincularam sua conta de não administrador na [!UICONTROL doohan] empresa de logon do Analytics à conta de organização [!UICONTROL Chapek] Corp Experience Cloud.
* Vincularam sua conta de não administrador na empresa de logon nigel do Analytics à conta de Experience Cloud Nigel Inc.
...
Em algum momento, esse conjunto de relatórios foi compartilhado com outra empresa de logon que pode fazer parte de uma organização do Experience Cloud diferente.
...
Essa notificação ajuda você a tomar uma decisão informada sobre o mapeamento do conjunto de relatórios. Queremos informá-lo de que o conjunto de relatórios foi criado originalmente em uma organização diferente, caso essa organização seja mais apropriada para esse conjunto de relatórios.
