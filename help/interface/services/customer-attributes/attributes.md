---
title: Sobre[!DNL Customer Attributes]
description: Saiba mais sobre [!DNL Customer Attributes] na Adobe CX Enterprise. Descubra como fazer upload dos dados de atributo de cliente para uso no Adobe Analytics e Adobe Target.
solution: Analytics
...
Os dados de clientes corporativos referem-se ao conjunto de informações coletadas em toda a organização sobre clientes, clientes potenciais e parceiros.Ela reside em outros sistemas e pode incluir informações como associações, nível de fidelidade, idade, gênero, produtos de propriedade, interesses e valor vitalício.
...
Depois que os dados residirem no CX Enterprise, você poderá personalizá-los e compartilhá-los nas soluções para relatórios, segmentação, atividades e campanhas.
