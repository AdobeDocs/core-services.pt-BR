---
description: Saiba mais sobre os requisitos de arquivos de dados e as múltiplas fontes de dados para carregar dados do  [!DNL Customer Attributes]  no Experience Cloud.
...
# Arquivos de dados e fontes de atributo do cliente
