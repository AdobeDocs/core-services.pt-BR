...
| É necessário migrar para o Serviço da Experience Cloud ID? | A migração depende dos aplicativos que você usa. <ul><li>Adobe Analytics: recomendado </li><li>Adobe Target: obrigatório. </li></ul><br>O uso do serviço da Experience Cloud ID habilita a funcionalidade de Experience Cloud mais recente, incluindo públicos em tempo real, a modernização do Adobe Target, a integração do Analytics e o rastreamento de video heartbeat. |
