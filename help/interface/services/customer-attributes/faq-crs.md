...
| Problema | Descrição |
|--- |--- |
| Limitações de assinatura do [!DNL Customer Attribute] | Ao atualizar para o Analytics Premium, há um atraso de 24 horas antes da disponibilização de mais atributos. Você pode ver um erro de [!UICONTROL Máximo de Assinatura de atributo] emitido durante esse atraso. |
