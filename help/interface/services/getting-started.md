...
>[!NOTE]
>
>Para obter a ajuda completa do Serviço da Experience Cloud ID (antiga ID de visitante), consulte [Visão geral do Serviço de Identidade da Experience Cloud](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html?lang=pt-BR#intro).
