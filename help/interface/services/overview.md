...
| [Pessoas -  [!DNL Audience Library]](audiences/overview.md) | Os públicos-alvo são coleções de visitantes (uma lista de IDs de visitante). A [!DNL Audience Library] da Adobe permite gerenciar a conversão de dados de visitante em uma segmentação de público-alvo. Como |
...
>[!NOTE]
>
>A documentação do produto da Experience Platform pode ser encontrada [aqui](https://experienceleague.adobe.com/docs/experience-platform/landing/home.html?lang=pt-BR). A documentação técnica para desenvolvedores da [!UICONTROL Experience Platform] se encontra no [Adobe Developer](https://developer.adobe.com/apis).
