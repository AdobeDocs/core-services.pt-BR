---
description: Saiba mais sobre fontes de dados de solução e como configurar assinaturas. As assinaturas permitem o fluxo de dados de atributos do cliente entre a Experience Cloud e soluções (Analytics e Target).
...
Saiba mais sobre fontes de dados de solução e como configurar assinaturas. As assinaturas permitem o fluxo de dados de atributos do cliente entre a Experience Cloud e soluções ([!DNL Analytics] e [!DNL Target]).
