...
Saiba mais sobre fontes de dados de aplicativo e como configurar assinaturas. As assinaturas permitem [!DNL Customer Attribute] fluxo de dados entre Experience Cloud e aplicativos ([!DNL Analytics] e [!DNL Target]).
